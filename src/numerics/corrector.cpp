...
void SymplecticCorrector::apply_forward(std::vector<Body>& bodies, const std::vector<Pair>& pairs, double dt, double G) const {
...
void SymplecticCorrector::apply_backward(std::vector<Body>& bodies, const std::vector<Pair>& pairs, double dt, double G) const {
